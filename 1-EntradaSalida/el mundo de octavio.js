...
// calculo papel
     ...
     alert ("El total de Mts de papel más el 10% para la cola es: "+totalPapel+" mts.");
      ...
      //Math.pow, hay indicarle al pow el nro y el exponente: Math.pow(base, exponente)
      //hipotenusaCorta = Math.sqrt(Math.pow((DC/2),2) + Math.pow((AB/3),2));
      //hipotenusaLarga = Math.sqrt(Math.pow((DC/2),2) + Math.pow((AB/3),2));
