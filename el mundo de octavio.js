...
// calculo papel
     ...
     totalx10=totalPapel*10
     alert ("El total de Mts de papel para 10 cometas más el 10% para la cola es: "+totalx10+" mts.");

// calculo papelo color
    totalx10=(totalPapel/2)*10;
    alert ("El total de Mts de papel de cada color para 10 cometas más el 10% para la cola es: "+totalx10+" mts.");
